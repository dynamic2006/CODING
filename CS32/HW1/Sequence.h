...
class Sequence
{
  public:
    ...
    const bool empty();  // Return true if the sequence is empty, otherwise false.
    const int size();    // Return the number of items in the sequence.
    ...
    const bool get(int pos, ItemType& value);
    ...
    const int find(const ItemType& value);
      // Let p be the smallest integer such that value == the item at
